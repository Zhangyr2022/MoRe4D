...
from .wan_transformer4d import WanTransformer4DModel
...
if importlib.util.find_spec("pai_fuser") is not None:
    ...
    WanTransformer4DModel.forward = simple_wrapper(WanTransformer4DModel.forward)
    import os
    ...
    WanTransformer4DModel.enable_cfg_skip = enable_cfg_skip()(WanTransformer4DModel.enable_cfg_skip)
    WanTransformer4DModel.disable_cfg_skip = disable_cfg_skip()(WanTransformer4DModel.disable_cfg_skip)
